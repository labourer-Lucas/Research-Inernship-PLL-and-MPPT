###########################################################################
## Makefile generated for component 'SRF_block'. 
## 
## Makefile     : SRF_block.mk
## Generated on : Sun Oct 12 18:48:32 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SRF_block.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SRF_block.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/SRF_block_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=SRF_block -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/SRF_block_ert_rtw/SRF_block.c $(START_DIR)/SRF_block_ert_rtw/SRF_block_data.c
...
OBJS = SRF_block.obj SRF_block_data.obj
...
%.obj : $(START_DIR)/SRF_block_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/SRF_block_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/SRF_block_ert_rtw/%.asm
	$(AS) $(ASFLAGS) "$<"


%.obj : $(START_DIR)/SRF_block_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
SRF_block.obj : $(START_DIR)/SRF_block_ert_rtw/SRF_block.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


SRF_block_data.obj : $(START_DIR)/SRF_block_ert_rtw/SRF_block_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
