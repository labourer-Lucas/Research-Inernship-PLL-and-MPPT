...
\subsubsection{Synchronous Reference Frame PLL}
\begin{figure}[H]
    \centering
...
\subsubsection{Decoupled Double Synchronous Reference Frame PLL}
\subsubsection{Second Order General Integrator PLL}
\subsubsection{Dual Second Order General Integrator PLL}
\subsubsection{Multi Second Order General Integrator PLL}
